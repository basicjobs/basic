...
public class JavaGen {
    ...
    private static String middle_pk_name = "basic/admin";   // 중분류(중분류 업무 패키지명)
    private static String down_pk_name = "rankingGrp";   // 하분류(하분류 업무 패키지명)
    private static String service_name = "RankingGrp";   //자바 앞에 붙는 서비스 명으로 앞의 글자 대문자!!!!!! service,dao,impl,web 경로 및 filename 이 설정 된다.
    private static String unitBizName="basic";
    private static String NaDa ="정지균";               // 작성자 명
    private static String screenTitle = "랭킹";    // 메뉴명 한글 설명을 넣으면 될듯합니다.
    private static String functionDesc = "CRUD";   // MVC 의 기능 설명

    private static String db_table = "ranking_grp";   // 테이블명
    private static String db_key = "RANKING_GRP_IDX";   // 테이블키
...
/*
    ...
    */
    ...
    private static String template_do_path= "/www/com/basic/admin/sample";
