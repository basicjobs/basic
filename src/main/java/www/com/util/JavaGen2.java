...
public class JavaGen2 {
    ...
    private static String middle_pk_name = "admin";   // 중분류(중분류 업무 패키지명)
    private static String middle_pk = "basic/admin";   // 중분류(중분류 업무 패키지명)
    private static String down_pk_name = "member";   // 하분류(하분류 업무 패키지명)
    private static String service_name = "Member";   //자바 앞에 붙는 서비스 명으로 앞의 글자 대문자!!!!!! service,dao,impl,web 경로 및 filename 이 설정 된다.
    private static String unitBizName="basic";
    private static String NaDa ="정지균";               // 작성자 명
    private static String screenTitle = "회원";    // 메뉴명 한글 설명을 넣으면 될듯합니다.
    private static String functionDesc = "CRUD";   // MVC 의 기능 설명
    
    private static String db_table = "member";   // 테이블명
    private static String db_key = "MEMBER_IDX";   // 테이블키
...
/*
    ...
    */
    ...
    private static String maxUp_pkg_name = ""+up_pk_name+"/"+middle_pk+"/"+down_pk_name;   //생성되는 패키지명
    ...
    private static String template_do_path= "/com/basic/admin/sample";
    ...
    public static void  getServicePath() {
        ...
        dao_java_name =  service_name+"Mapper";
        ...
        impl_java_name =service_name+"Service"+"Impl";
            ...
            if(fn.fileExists(web_path+"/"+web_java_name+".java")){
                ...
                try {
                    ...
                    if(fn.fileExists(original_java)) {
                        ...
                        newLine = newLine.replaceAll("com.basic.sample", maxUp_pkg_name.replaceAll("/", "."));
    ...
    public static void  createSql() {
        try {
            String original_java = full_path.replace("java", "resources")+ "/mapper/admin/TemplateMapper.xml";
